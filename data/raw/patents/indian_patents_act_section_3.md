# The Patents Act, 1970 (Section 3 Excerpts)

**Authority:** Controller General of Patents, Designs and Trade Marks (CGPDTM)
**Jurisdiction:** India (IN)
**Category:** PATENT
**Subject:** What are not inventions (Non-Patentable Subject Matter)
...
### Focus Area for Ayurvedic Innovation: Section 3(p) & Section 3(e)
- **Section 3(p) (Traditional Knowledge):** Direct extractions from classical texts like the *Charaka Samhita* or *Ayurvedic Pharmacopoeia of India (API)* are strictly barred from patentability. The Traditional Knowledge Digital Library (TKDL) is frequently used by patent examiners to establish prior art and invoke Section 3(p).
- **Section 3(e) (Mere Admixture):** A polyherbal formulation (combining multiple known herbs) is considered a "mere admixture" and rejected under Section 3(e) unless the patent applicant provides explicit clinical or experimental data proving **synergism** (that the combined effect is significantly greater than the sum of the individual herbal effects).
